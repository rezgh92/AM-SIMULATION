...
\paragraph{Crystallisation kinetics} With the rate constant calibrated as described in Section~\ref{sec:densification}, the simulated exotherm at 10~K\,min$^{-1}$ peaks within 0.01~K of the prescribed temperature for Avrami exponents between 1 and 4.
