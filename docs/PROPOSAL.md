...
**(e) Phosphorus.** At 450 nm only BAPO-class acylphosphine oxides and acylgermanes are practical photoinitiators, and many LCM dispersants are phosphate esters. At BAPO 0.5–2 wt% of the organic fraction the all-retained P budget is 30–182 ppm, costing 2.2–13 %IACS. Assay for **P, Ge, Sn, S** — not P alone.
*Correction (implementation stage):* an earlier version of this section claimed trace P forms liquid via the 714 °C Cu–Cu₃P eutectic. That is wrong at these levels — the solid solubility of P in Cu is ~1.7 wt% at 714 °C, so 30–180 ppm dissolves completely. Phosphorus costs **conductivity**, not melting (except where P is locally concentrated before it dissolves).
